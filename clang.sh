...
echo "Set DEFCONFIG"
echo
make CC='ccache clang -Qunused-arguments -fcolor-diagnostics' AR=llvm-ar NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip O=out lavender-perf_defconfig
